		...
		<section className='hero container w-100'>
			<div className='d-flex flex-column align-items-start'>
				...
				<div className="d-flex gap-3 align-items-center mt-lg-0 mt-4 ms-1">
					<span className="p-2 badge rounded-pill float text-success border border-success">AVAIBLE FOR WORK</span>
							...
							<section>
								...
								<aside>
									...
									<ul>
										...
										<li>Only candidate to develop an <strong>effective responsive design</strong>. </li>
										<li>Excellent UX.</li>
									</ul>
								</aside>
							</section>
			...
			<svg className='curva' width="86" height="81" viewBox="0 0 86 81" fill="none" xmlns="http://www.w3.org/2000/svg">
				...
				<path d="M5 0L86 0L5 0ZM86 81H35C15.67 81 0 65.33 0 46H10C10 59.8071 21.1929 71 35 71H86V81ZM35 81C15.67 81 0 65.33 0 46V0L10 0V46C10 59.8071 21.1929 71 35 71V81ZM86 0V76V0Z" fill="#EEB92F" mask="url(#path-1-outside-1_199_1091)" />
			</svg>
		</section>
	)
}
